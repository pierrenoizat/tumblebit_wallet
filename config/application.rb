...
module Tumblebit
  class Application < Rails::Application
    ...
    # $NETWORK_FEE = 50000  # network fee in satoshis
    # $AMOUNT = 500000 # ~ 7.50 €
    $NETWORK_FEE = 200000 # network fee in satoshis
    $AMOUNT = 20000000 # ~ 300 €  @ 1 500 €/BTC
    ...
    $PAYMENT_API_URL = "https://fierce-ocean-41496.herokuapp.com/api/v1/payment"
  end
end
